        ...
        return (
            <View pointerEvents="none" key={index + "view"}>
                <TextInput
                    ...
                    style={selectedIndex === index ? [defaultTextFieldStyle, codeInputFieldStyle, codeInputHighlightStyle,{color:'white'}] : [defaultTextFieldStyle, codeInputFieldStyle,{color:'white'}]}
